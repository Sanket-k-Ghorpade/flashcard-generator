                  ...
                  <div className="flex flex-col w-full">
                    {cards && cards.length > 0
                      ? cards.map((card, index) => (
                          <div
                            key={index}
                            className="md:flex 2xl:flex gap-6 pr-4 pt-4"
                          >
                            ...
                            <div className="">
                              {card.cardImage ? (
                                <div className="flex">
                                  ...
                                  <button
                                    className="absolute z-50 rounded-2xl ml-[4px] h-auto mt-8 border-red-600 border-2 text-xs text-red-700"
                                    onClick={() =>
                                      handleCardImageClick(index, setFieldValue)
                                    }
                                  >
                                    {" "}
                                    <AiOutlineClose />{" "}
                            ...
                            drop-shadow-lg font-semibold rounded-md"
                                ...
                                >
                                  <input
                                    type="file"
                                    ref={(ref) =>
                                      (filePickerRef.current[index] = ref)
                                    }
